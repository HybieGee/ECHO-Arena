          ...
          >
            ...
            <div className="border-t border-echo-magenta/20 pt-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="text-xl font-bold text-echo-gold">{upgrade.price}</div>
              </div>
              <button
                disabled
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-arena-surface rounded-lg p-6 border border-echo-magenta/30">
            <div className="text-center mb-4">
              ...
              <div className="text-2xl font-bold text-echo-gold">750 $ECHO</div>
              <div className="text-xs text-echo-muted line-through">900 $ECHO</div>
            </div>
            ...
            <div className="text-center">
              <span className="inline-block px-3 py-1 bg-neon-green/20 text-neon-green rounded-full text-xs font-bold">
                SAVE 17%
              </span>
            </div>
          </div>
          ...
          <div className="bg-arena-surface rounded-lg p-6 border-2 border-echo-cyan/50 relative">
            ...
            <div className="text-center mb-4">
              ...
              <div className="text-2xl font-bold text-echo-gold">1,400 $ECHO</div>
              <div className="text-xs text-echo-muted line-through">1,750 $ECHO</div>
            </div>
            <ul className="space-y-2 text-sm mb-4">
              <li className="flex items-center gap-2">
                <span className="text-neon-green">✓</span>
            ...
            <div className="text-center">
              <span className="inline-block px-3 py-1 bg-echo-cyan/20 text-echo-cyan rounded-full text-xs font-bold">
                SAVE 20%
              </span>
            </div>
          </div>
          ...
          <div className="bg-arena-surface rounded-lg p-6 border border-echo-gold/50">
            <div className="text-center mb-4">
              ...
              <div className="text-2xl font-bold text-echo-gold">2,500 $ECHO</div>
              <div className="text-xs text-echo-muted line-through">3,150 $ECHO</div>
            </div>
            <ul className="space-y-2 text-sm mb-4">
              <li className="flex items-center gap-2">
                <span className="text-neon-green">✓</span>
            ...
            <div className="text-center">
              <span className="inline-block px-3 py-1 bg-echo-gold/20 text-echo-gold rounded-full text-xs font-bold">
                SAVE 21%
              </span>
            </div>
          </div>
